...
export default function Terms() {
  return (
    <main className="w-full flex flex-col items-center relative overflow-hidden px-6 py-12 md:px-16 md:py-24">
      ...
      {/* Animated Ambient Glow Effects adapted for light mode */}
      ...
      <div className="w-full max-w-5xl relative z-10">
        ...
        <motion.section 
          ...
          className="w-full bg-[var(--theme-card-bg)] border border-gray-200 rounded-3xl p-8 md:p-12 shadow-xl"
        >
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 border-b border-gray-200 pb-6">
            <div>
              <h2 className="text-3xl font-bold text-[var(--theme-text-main)] mb-2">Terms & Conditions</h2>
              <p className="text-[var(--theme-text-muted)] text-sm">Effective Date: 5 January 2026 | Jurisdiction: Republic of South Africa</p>
            </div>
            <div className="mt-4 md:mt-0 px-4 py-2 bg-gray-50 rounded-lg border border-gray-200 text-xs text-[var(--theme-text-muted)] font-medium">
              Service Provider: Dankie (TACT)
            </div>
          </div>
          
          <div className="h-96 overflow-y-auto pr-4 text-[var(--theme-text-muted)] text-sm space-y-6 custom-scrollbar">
            
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">1. ACCEPTANCE OF TERMS</h3>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">2. DEFINITIONS</h3>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">3. ACCOUNT REGISTRATION AND ELIGIBILITY</h3>
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">3.1 Guest Access</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">3.2 Proxy Registration (Elderly Member Clause)</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">3.3 Account Security</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">3.4 Account Suspension and Termination</p>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">4. BIOMETRIC AUTHENTICATION</h3>
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">4.1 Purpose and Mandatory Use</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">4.2 Consent to Processing</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">4.3 Third-Party Uploads</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">4.4 Biometric Data Deletion</p>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">5. MARKETPLACE AND COMMISSIONS</h3>
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">5.1 Platform Role</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">5.2 Commission Structure</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">5.3 Seller Payouts</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">5.4 Seller Obligations</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">5.5 Refunds, Chargebacks, and Disputes</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">5.6 Tax and VAT Responsibility</p>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">6. OVERSEER SUBSCRIPTIONS & FINANCIAL REPORTING</h3>
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">6.1 Subscription Tiers</p>
              <p>Subscription fees are charged monthly based on member count: 0–49: Free | 50–199: R189 | 200–399: R389 | 400+: R689</p>
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">6.2 Non-Payment</p>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">6.3 Financial Accuracy Disclaimer</p>
              <p>All financial data is user-generated. Dankie is not an accounting firm and does not audit or verify financial records.</p>
            </div>

            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">7. TACTSO & UNIVERSITY APPLICATIONS</h3>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">8. CAREERS AND EXTERNAL LINKS</h3>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">9. INTELLECTUAL PROPERTY</h3>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">10. LIMITATION OF LIABILITY</h3>
              ...
              <p className="font-semibold text-[var(--theme-text-main)] mt-3 mb-1">10.1 Force Majeure</p>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">11. GOVERNING LAW</h3>
              <p>These Terms are governed by the laws of the Republic of South Africa.</p>
            </div>

            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">12. AMENDMENTS</h3>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">13. USER-GENERATED CONTENT</h3>
            ...
            <div>
              <h3 className="text-[var(--theme-text-main)] font-bold text-lg mb-2">14. SERVICE PROVIDER</h3>
      ...
      {/* Scrollbar styling updated for light mode */}
