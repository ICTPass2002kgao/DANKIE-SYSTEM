...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[var(--theme-bg-start)] via-[var(--theme-bg-mid)] to-[var(--theme-bg-end)] text-white flex flex-col items-center relative overflow-hidden px-6 py-12 md:px-16 md:py-24">
      ...
      {/* Ambient Glow Effects (Thematic Background) */}
      ...
      <div className="w-full max-w-4xl relative z-10">
        ...
        <motion.section 
          ...
          className="w-full bg-[#0a0a0a]/90 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 md:p-14 shadow-2xl"
        >
          {/* Header */}
          <div className="border-b border-gray-800 pb-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-400">
              <div>
                <p><strong className="text-gray-300">Effective Date:</strong> 5 January 2026</p>
                <p><strong className="text-gray-300">Last Updated:</strong> 22 May 2026</p>
              </div>
              <div>
                <p><strong className="text-gray-300">Jurisdiction:</strong> Republic of South Africa</p>
                <p><strong className="text-gray-300">Regulatory Compliance:</strong> POPIA & GDPR-aligned</p>
              </div>
            </div>
          </div>
          
          {/* Document Content */}
          <div className="text-gray-300 text-sm md:text-base leading-relaxed space-y-8">
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">2. INFORMATION COLLECTION</h2>
              ...
              <h3 className="text-white font-semibold text-lg mt-4 mb-2">2.1 Information You Provide Directly</h3>
              ...
              <h3 className="text-white font-semibold text-lg mt-4 mb-2">2.2 Automated Data Collection</h3>
              ...
              <h3 className="text-white font-semibold text-lg mt-4 mb-2">2.3 Biometric Information</h3>
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">3. BIOMETRIC DATA & SECURITY POLICIES</h2>
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">4. HOW WE USE YOUR INFORMATION</h2>
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">5. DATA SHARING & THIRD PARTIES</h2>
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">6. DATA RETENTION & SECURITY</h2>
              <p>
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">8. YOUR RIGHTS UNDER POPIA</h2>
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">9. POLICY UPDATES</h2>
              <p>
            ...
            <div>
              <h2 className="text-white font-bold text-xl mb-3">10. CONTACT US</h2>
              <p>
