...
void showSignatureDialog(
  ...
  showDialog(
    ...
    builder: (ctx) {
      // THE FIX: Provide an explicit width so the Canvas does not collapse to 0x0
      ...
      return AlertDialog(
        ...
        content: SizedBox(
          width: canvasWidth, // Constrain the dialog content
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Container(
                width: canvasWidth, // Constrain the wrapper
                ...
                child: ClipRRect(
                  ...
                  child: Signature(
                    ...
                    height: 150,
                    width:
                        canvasWidth, // Force the signature pad to have an explicit width
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          CupertinoSwitch(
                            ...
                            onChanged: (val) {
                              setDialogState(() => isReadyForMembership = val);
                            },
                          ),
                        ],
                      ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      "Assign a new testify to $universityName.",
                      style: TextStyle(
                        fontSize: 13,
                        color: Colors.grey.shade600,
                      ),
