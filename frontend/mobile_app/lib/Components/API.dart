...
class Api {
  ...
  /// Returns a header widget for use in your screens.
  /// Place this inside your widget tree where needed.
  Widget? buildAppBar(BuildContext context, String headerTitle) {
    final theme = Theme.of(context);
    return Container(
